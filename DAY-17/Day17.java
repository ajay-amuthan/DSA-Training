...
public class Day17 {
    ...
    public static class PermutationStringSolution {
        public void backtrack(char[] chars, int index, List<String> result) {
    ...
    public static class LetterCombinationsSolution {
        public void backtrack(String digits, String[] map, int index, StringBuilder current, List<String> result) {
